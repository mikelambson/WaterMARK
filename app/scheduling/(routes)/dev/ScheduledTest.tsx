...
const ScheduledColumn = () => {
    ...
    return (    
        <Tabs defaultValue="1" className="relative p-2 w-full h-[82.5vh] bg-foreground/10 dark:bg-foreground/75 rounded-md">
            ...
            <TabsContent key={selectedSheet.name === "Select" ? "1" : "0"} value={selectedSheet.name === "Select" ? "1" : "0"} className="h-[72.75vh]">
            ...
            {Array.from({ length: selectedSheet.maxHeads }, (_, index) => (
                <TabsContent key={+selectedSheet.name + index + 10} value={`${index + 1}`} className="h-[29rem]">
                    ...
                    <ScrollArea className="h-[71vh] rounded-md bg-black/10">
            ...
            <TabsContent key={+selectedSheet.name + 10} value={"10"} className="h-[29rem]">
                ...
                <ScrollArea className="w-full h-[71vh] rounded-md bg-black/10 px-[0.5rem]">
