    ...
    return ( 
        ...
        >
            ...
            gap-0 rounded-sm align-text-bottom">
                ...
                <div className={cn("col-span-3 text-bottom row-start-2 border-b-2 font-semibold truncate text-amber-300/70 dark:text-amber-400/60 border-gray-200/60  dark:border-gray-600")}>{schedule.watermasterNote}</div>
                <div className="col-start-1 row-start-4"></div>
                <div className={cn("row-span-2 col-start-2 row-start-3 border-r-2 text-sm pt-2 text-gray-200 dark:text-foreground border-gray-200/60 dark:border-gray-600 " )}>{schedule.scheduledDate}</div>
                <div className={cn("col-start-3 row-start-3 border-r-2 pl-1 font-medium text-gray-200 dark:text-foreground border-gray-200/60 dark:border-gray-600" )}>Schedule# {id}</div>
