...
const Deliveries = ({ id, columns, index }: Properties) => {
    ...
    return (   
        <div className="relative w-full min-h-[71svh] md:min-h-[84svh] p-2 bg-foreground/10 dark:bg-foreground/75 rounded-md shadow-md">
        <Tabs key={("scheduledcolumn" + selectedSheet.name)} defaultValue={"1"} className="w-full h-full pb-0">
                ...
                <TabsContent  value={selectedSheet.id === 0 ? "1" : "0"} className="h-full">
                    <div className="w-full min-h-[62svh] md:min-h-[75svh] h-full flex flex-col justify-center text-center text-6xl md:text-8xl rounded-md bg-black/25 shadow-md">
