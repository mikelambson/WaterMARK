  ...
  return (
    <div className="p-2 ml-4">
      ...
      <div className="m-8 border-2 border-black/10 dark:border-gray-500/10 rounded-lg bg-card grid grid-cols-2 grid-flow-col p-6 min-h-[50dvh] h-full gap-8">
        <div className="border-2 border-muted bg-black/25 rounded-lg py-4 px-8"> 
        ...
        <div className="border-2 border-muted bg-black/25 rounded-lg py-4 px-8"> 
          ...
          <p>Change to react-dnd-kit to make use of SSE and allow for live/refreshed/reordered schedules</p>
        </div>
      </div>
    </div>
  );
