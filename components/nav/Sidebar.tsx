          ...
          <div className="mb-5">
            {sideLinks.map((item: any) => (
              <div
                key={item.id}
                className={cn(
                  "py-2 border-r border-b border-t rounded-r-sm ",
                  pathname === item.link
                    ? cn(
                        isDarkMode
                          ? "border-t-yellow-50/5 border-b-yellow-900/10 border-r-yellow-700/40 bg-gradient-to-l from-yellow-700/30 via-yellow-700/20 to-yellow-700/10"
                          : "border-t-orange-50/5 border-b-orange-950/20 border-r-orange-300/40 bg-gradient-to-l from-orange-300/30 via-orange-300/20 to-orange-300/10"
                      )
              ...
              >
                <Link
                  ...
                  className={cn(
                    ...
                    pathname === item.link
                      ? cn(
                          isDarkMode ? "text-yellow-900" : "text-orange-300/95"
                        )
